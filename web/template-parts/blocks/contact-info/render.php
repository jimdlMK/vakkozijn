...
<section class="mk-contact-info-block">
    <div class="mk-contact-info-block__inner">
        ...
        <div class="mk-contact-info-block__right">
            ...
            <div class="mk-contact-info-block__socials">
                <p class="mk-contact-info-block__socials-titel">Volg ons</p>
                <div class="socials-container">
                    <div class="socials">
                        ...
                        <?php if ( file_exists( $icon_path ) ) : ?>
                            <a class="socials__item socials__item--<?php echo esc_attr( $social ); ?>"
